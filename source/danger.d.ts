...
interface GitlabChangesValueAddModifyDelete {
  type: "ADD" | "MODIFY" | "DELETE"
  path: {
    toString: string
  }
...
interface GitlabChangesValueMove {
  type: "MOVE"
  path: {
    toString: string
  }
...
type GitlabChangesValue = GitlabChangesValueAddModifyDelete | GitlabChangesValueMove
